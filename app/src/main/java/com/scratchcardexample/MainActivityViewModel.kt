...
class MainActivityViewModel @Inject constructor(): ViewModel() {
    ...
    fun updateHeader(route: String) {
        val value = when(route) {
            ROUTE_ACTIVATION -> com.scratchcardexample.feature.activation.R.string.title_activation
            ROUTE_SCRATCH -> com.scratchcardexample.feature.scratchscreen.R.string.scratch
